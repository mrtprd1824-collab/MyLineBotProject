...
# ▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼
# --- ส่วนที่แก้ไขใหม่: ฟังก์ชันกลางสำหรับเชื่อมต่อและสร้างฐานข้อมูล ---
def get_db_connection():
    """
    ฟังก์ชันนี้จะเชื่อมต่อกับฐานข้อมูล
    และสร้างตาราง 'messages' ให้โดยอัตโนมัติถ้ายังไม่มี
    """
    ...
    ''')
    conn.commit()
    # ทำให้ผลลัพธ์จาก DB เป็น dict เพื่อให้ใช้ง่ายใน HTML
...
@app.route("/admin")
def admin_page():
    conn = get_db_connection() # << แก้ไข: เรียกใช้ฟังก์ชันกลาง
    cursor = conn.cursor()
...
# --- Webhook และฟังก์ชัน handle_message ---
...
# --- ส่วนเริ่มรันเซิร์ฟเวอร์ (ไม่ต้องทำอะไรเป็นพิเศษแล้ว) ---
